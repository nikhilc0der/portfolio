      ...
      <div className="custom-container">
        <div className="testimonial-content content-width">
          <div className="section-header">
            ...
            >
              <i className="lar la-comment" /> testimonial
            </h4>
              ...
              <div className="testimonial-item">
                <div className="testimonial-item-inner">
                  ...
                  <p>
                    ...
                    master of code. Much more than what I am expect. High
                    quality product &amp; flexiable price. Recommended!.”
                  </p>
                  ...
                  <div className="author d-flex align-items-center">
                    ...
                    <div className="right">
                      ...
                      <p className="designation">
                        ...
                        <span>Invision App Inc</span>
                      </p>
                    </div>
                  </div>
                  <p>
                    “Drake was a real pleasure to work with and we look forward
                    to working with him again. He is definitely the kind of
